...
IMG_WIDTH = 160*2
IMG_HEIGHT = 120*2
IMG_ROWS = IMG_HEIGHT*IMG_WIDTH//100
# IMG_ROWS = 3072
# IMG_ROWS = 1536
COMA_POSITION = 3
PIPE_POSITION = 8
BARE_LINE_LENGTH_NO_NL_CHRS = 109
LINE_DATA_LENGTH_NO_NL_CHRS = 100
LINE_DATA_LENGTH = 102
...
def getRowFromMcu(rowNumber):
	...
	while ser.in_waiting != LINE_DATA_LENGTH:
